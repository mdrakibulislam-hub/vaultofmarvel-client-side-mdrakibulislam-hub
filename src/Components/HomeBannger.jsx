...
const HomeBannger = () => {
    ...
    return (
        <div className='bg-black py-16'>
            <div data-aos="fade-up" className='main-container grid grid-cols-2 justify-center items-center'>
                <div>
                    <img src={logo} alt="" />
                    ...
                    <button className="btn border-none bg-primary text-white hover:bg-warning hover:text-neutral ">Buy Now</button>
                </div>
